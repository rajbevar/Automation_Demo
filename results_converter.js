...
var fs = require('fs');
//var modifyDataFiles = require('../../data/modify_data_files.js');
//var utilities = require("./utilities.js")

var ResultsConverter = {

  /**
   * Constructor for convertResultsToXrayFormat : This is the primary function called from the gulp task, it executes associated functions in proper sequence
   */
  convertResultsToXrayFormat: function(sourceFilePath, sourceFileName, destinationFilePath) {
    sourceFileFullPathAndName = (sourceFilePath + sourceFileName);
    var destinationFileName = ('xray_format_' + sourceFileName);
    var destinationFileNameForFailedTests = ('failed_tests_' + sourceFileName);

    console.log(sourceFileFullPathAndName);

    /* Execute in sequence:
     * 1) Read .json source file to obj1
     * 2) Create empty obj2
     * 3) Parse obj1 and write relevant info to obj2 in alternate format
     * 4) Construct filename for obj2
     * 5) Write obj2 to new .json file
     */

    //read the json file
    utilities.readTestDataObjectFile(sourceFileFullPathAndName, function(dataObject) {

      // var xrayResultsFormatObject = { tests: [] };
      ...
      utilities.updateTestDataObjectFile(destinationFilePath, destinationFileName, xrayResultsFormatObject, function(callback) {
        //file update complete
        console.log('Results Converter : write to file complete');

      });

    });

    convertResultsToXrayFormat("/Users/rajani/Automation_Demo/reports", "cucumber-report.json", "/Users/rajani/Automation_Demo/reports");
  }


};

//module.exports = ResultsConverter;


module.exports.convertResultsToXrayFormat = function (sourceFilePath, sourceFileName, destinationFilePath) {
  var moment = require('moment');
  var _ = require('lodash');
  var fs = require('fs');
